																...
																<tbody>
																	<tr>
																		...
																		<td class="red-right"><a class="close-red"> <img
																				src="images/table/icon_close_red.gif" alt=""></a>
																		</td>
																	</tr>
																</tbody>
															</table>
											...
											<table border="0" cellpadding="0" cellspacing="0"
												...
												<tr>
													...
													<td><input type="text" name="firstname" id="firstname"
														value="${firstname}" class="inp-form" /></td>
													<td></td>
												</tr>
												<tr>
													<th valign="top">Last Name:</th>
													<td><input type="text" name="lastname" id="lastname"
														value="${lastname}" class="inp-form" /></td>
													<td></td>
												</tr>
												<tr>
													...
													<td><input type="text" autocomplete="off"
														...
														class="inp-form" /></td>
													<td><span id="username_error">
															</div></td>
												</tr>
												<tr>
													<th valign="top">New Password:</th>
													<td><input type="password" autocomplete="off"
														name="password" id="password" class="inp-form" /></td>
													<td></td>
												</tr>
												...
												<tr>
													...
													<td><input type="password" autocomplete="off"
														name="password_re" id="password_re" class="inp-form" /></td>
													<td><span id="password_re_error">
															</div></td>
												</tr>
